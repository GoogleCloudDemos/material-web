...
export const styles = css`
  ...
  @layer styles {
      ...
      margin: max(
          ...
          (
              calc(48 * var(--md-sys-globalscale, 1px)) -
                var(--md-switch-track-height, calc(32 * var(--md-sys-globalscale, 1px)))
            )/2
        )
        calc(0 * var(--md-sys-globalscale, 1px));
    }
    ...
    .switch {
      ...
      flex-shrink: 0;
      position: relative;
      width: var(--md-switch-track-width, calc(52 * var(--md-sys-globalscale, 1px)));
      height: var(--md-switch-track-height, calc(32 * var(--md-sys-globalscale, 1px)));
    ...
    input {
      ...
      height: max(
        100%,
        var(--md-switch-touch-target-size, calc(48 * var(--md-sys-globalscale, 1px)))
      );
      outline: none;
      margin: 0;
      position: absolute;
  ...
  @layer styles {
    ...
    .unselected .track::before {
      ...
      border-style: solid;
      border-width: var(--md-switch-track-outline-width, calc(2 * var(--md-sys-globalscale, 1px)));
    }
    .unselected:hover .track::before {
      ...
      border-color: var(
        --md-switch-hover-track-outline-color,
    ...
    .unselected:focus-visible .track::before {
      ...
      border-color: var(
        --md-switch-focus-track-outline-color,
        var(--md-sys-color-outline, #79747e)
      );
    }
    .unselected:active .track::before {
      ...
      border-color: var(
        --md-switch-pressed-track-outline-color,
        var(--md-sys-color-outline, #79747e)
      );
    }
  ...
  @layer styles {
    ...
    .selected .handle-container {
      margin-inline-start: calc(
        var(--md-switch-track-width, calc(52 * var(--md-sys-globalscale, 1px))) -
          var(--md-switch-track-height, calc(32 * var(--md-sys-globalscale, 1px)))
      );
    }
    ...
    .handle {
      ...
      height: var(--md-switch-handle-height, calc(16 * var(--md-sys-globalscale, 1px)));
      width: var(--md-switch-handle-width, calc(16 * var(--md-sys-globalscale, 1px)));
    ...
    .selected .handle {
      height: var(--md-switch-selected-handle-height, calc(24 * var(--md-sys-globalscale, 1px)));
      width: var(--md-switch-selected-handle-width, calc(24 * var(--md-sys-globalscale, 1px)));
    }
    .handle.with-icon {
      height: var(--md-switch-with-icon-handle-height, calc(24 * var(--md-sys-globalscale, 1px)));
      width: var(--md-switch-with-icon-handle-width, calc(24 * var(--md-sys-globalscale, 1px)));
    }
    .selected:not(.disabled):active .handle,
    .unselected:not(.disabled):active .handle {
      height: var(--md-switch-pressed-handle-height, calc(28 * var(--md-sys-globalscale, 1px)));
      width: var(--md-switch-pressed-handle-width, calc(28 * var(--md-sys-globalscale, 1px)));
      transition-timing-function: linear;
    ...
    .unselected:active .handle::before {
      background-color: var(
        --md-switch-pressed-handle-color,
        var(--md-sys-color-on-surface-variant, #49454f)
      );
    }
    ...
    md-ripple {
      border-radius: var(
        --md-switch-state-layer-shape,
        var(--md-sys-shape-corner-full, calc(9999 * var(--md-sys-globalscale, 1px)))
      );
      height: var(--md-switch-state-layer-size, calc(40 * var(--md-sys-globalscale, 1px)));
      inset: unset;
      width: var(--md-switch-state-layer-size, calc(40 * var(--md-sys-globalscale, 1px)));
    }
    .selected md-ripple {
  ...
  @layer styles {
    ...
    .icon--off {
      width: var(--md-switch-icon-size, calc(16 * var(--md-sys-globalscale, 1px)));
      height: var(--md-switch-icon-size, calc(16 * var(--md-sys-globalscale, 1px)));
      color: var(--md-switch-icon-color, var(--md-sys-color-surface-container-highest, #e6e0e9));
    }
    .unselected:hover .icon--off {
      color: var(
        --md-switch-hover-icon-color,
        var(--md-sys-color-surface-container-highest, #e6e0e9)
      );
    }
    .unselected:focus-within .icon--off {
      color: var(
        --md-switch-focus-icon-color,
        var(--md-sys-color-surface-container-highest, #e6e0e9)
      );
    }
    .unselected:active .icon--off {
      color: var(
        --md-switch-pressed-icon-color,
        var(--md-sys-color-surface-container-highest, #e6e0e9)
      );
    }
    .unselected.disabled .icon--off {
      color: var(
        --md-switch-disabled-icon-color,
        var(--md-sys-color-surface-container-highest, #e6e0e9)
      );
      opacity: var(--md-switch-disabled-icon-opacity, 0.38);
    }
    .icon--on {
      width: var(--md-switch-selected-icon-size, calc(16 * var(--md-sys-globalscale, 1px)));
      height: var(--md-switch-selected-icon-size, calc(16 * var(--md-sys-globalscale, 1px)));
      color: var(
