...
export const styles = css`
  :host {
    ...
    --_leading-icon-size: var(
      --md-filled-text-field-leading-icon-size,
    ...
    --_trailing-icon-size: var(
      --md-filled-text-field-trailing-icon-size,
      calc(24 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_icon-input-space: var(
      --md-filled-text-field-icon-input-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    --_leading-space: var(
      --md-filled-text-field-leading-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    --_trailing-space: var(
      --md-filled-text-field-trailing-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    --_top-space: var(--md-filled-text-field-top-space, calc(16 * var(--md-sys-globalscale, 1px)));
    --_bottom-space: var(
      --md-filled-text-field-bottom-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_with-leading-icon-leading-space: var(
      --md-filled-text-field-with-leading-icon-leading-space,
      calc(12 * var(--md-sys-globalscale, 1px))
    );
    --_with-trailing-icon-trailing-space: var(
      --md-filled-text-field-with-trailing-icon-trailing-space,
      calc(12 * var(--md-sys-globalscale, 1px))
    );
    ...
    --md-filled-field-with-trailing-content-trailing-space: var(
      --_with-trailing-icon-trailing-space
    );
  }
`
