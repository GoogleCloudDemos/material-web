...
export const styles = css`
  :host {
    ...
    --_leading-icon-size: var(
      --md-outlined-text-field-leading-icon-size,
    ...
    --_outline-width: var(
      --md-outlined-text-field-outline-width,
      calc(1 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_trailing-icon-size: var(
      --md-outlined-text-field-trailing-icon-size,
      calc(24 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_icon-input-space: var(
      --md-outlined-text-field-icon-input-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    --_leading-space: var(
      --md-outlined-text-field-leading-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    --_trailing-space: var(
      --md-outlined-text-field-trailing-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    --_top-space: var(
      --md-outlined-text-field-top-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    --_bottom-space: var(
      --md-outlined-text-field-bottom-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_with-leading-icon-leading-space: var(
      --md-outlined-text-field-with-leading-icon-leading-space,
      calc(12 * var(--md-sys-globalscale, 1px))
    );
    --_with-trailing-icon-trailing-space: var(
      --md-outlined-text-field-with-trailing-icon-trailing-space,
      calc(12 * var(--md-sys-globalscale, 1px))
    );
    ...
    --md-outlined-field-with-leading-content-leading-space: var(
      --_with-leading-icon-leading-space
    );
