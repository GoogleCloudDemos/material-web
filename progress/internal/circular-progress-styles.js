...
export const styles = css`
  :host {
    ...
    --_size: var(--md-circular-progress-size, calc(48 * var(--md-sys-globalscale, 1px)));
    display: inline-flex;
  ...
  .progress {
    flex: 1;
    align-self: stretch;
    margin: calc(4 * var(--md-sys-globalscale, 1px));
  }
  .progress,
  .spinner,
  .left,
  ...
  .circle {
    ...
    border: solid
      calc(
        var(--_active-indicator-width) / 100 *
          (var(--_size) - calc(8 * var(--md-sys-globalscale, 1px)))
      );
    border-color: var(--_active-indicator-color) var(--_active-indicator-color) rgba(0, 0, 0, 0)
      rgba(0, 0, 0, 0);
