...
export const styles = css`
  :host {
    ...
    display: flex;
    position: relative;
    min-width: calc(80 * var(--md-sys-globalscale, 1px));
  ...
  @keyframes primary-indeterminate-translate {
    0% {
      transform: translateX(calc(0 * var(--md-sys-globalscale, 1px)));
    }
    20% {
  ...
  @media (forced-colors: active) {
    :host {
      outline: calc(1 * var(--md-sys-globalscale, 1px)) solid CanvasText;
    }
    .bar-inner,
    .dots {
