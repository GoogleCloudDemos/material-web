  ...
  @layer styles {
    :host {
      ...
      --_hover-outline-width: var(
        --md-outlined-field-hover-outline-width,
        calc(1 * var(--md-sys-globalscale, 1px))
      );
      ...
      --_leading-space: var(
        --md-outlined-field-leading-space,
        calc(16 * var(--md-sys-globalscale, 1px))
      );
      --_outline-color: var(
      ...
      --_top-space: var(--md-outlined-field-top-space, calc(16 * var(--md-sys-globalscale, 1px)));
      --_trailing-content-color: var(
        --md-outlined-field-trailing-content-color,
        var(--md-sys-color-on-surface-variant, #49454f)
      );
      --_trailing-space: var(
        --md-outlined-field-trailing-space,
        calc(16 * var(--md-sys-globalscale, 1px))
      );
