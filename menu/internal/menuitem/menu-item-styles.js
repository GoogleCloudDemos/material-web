...
export const styles = css`
  ...
  md-item {
    ...
    min-height: var(
      --md-menu-item-one-line-container-height,
      calc(56 * var(--md-sys-globalscale, 1px))
    );
    padding-top: var(--md-menu-item-top-space, calc(12 * var(--md-sys-globalscale, 1px)));
    padding-bottom: var(--md-menu-item-bottom-space, calc(12 * var(--md-sys-globalscale, 1px)));
    padding-inline-start: var(
      --md-menu-item-leading-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    padding-inline-end: var(
      --md-menu-item-trailing-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
  }
  md-item[multiline] {
    min-height: var(
      --md-menu-item-two-line-container-height,
      calc(72 * var(--md-sys-globalscale, 1px))
    );
  }
  [slot='supporting-text'] {
    color: var(
      --md-menu-item-supporting-text-color,
    ...
    font-size: var(
      --md-menu-item-supporting-text-size,
      var(
  ...
  [slot='trailing-supporting-text'] {
    color: var(
      --md-menu-item-trailing-supporting-text-color,
      var(--md-sys-color-on-surface-variant, #49454f)
    );
    font-family: var(
    ...
    font-size: var(
      --md-menu-item-trailing-supporting-text-size,
      var(
  ...
  [slot='end'] {
    color: var(
      --md-menu-item-trailing-icon-color,
      var(--md-sys-color-on-surface-variant, #49454f)
    );
  }
  .list-item {
  ...
  @media (forced-colors: active) {
    ...
    .list-item.selected::before {
      ...
      border-radius: inherit;
      pointer-events: none;
      border: calc(3 * var(--md-sys-globalscale, 1px)) double CanvasText;
    }
  }
`
