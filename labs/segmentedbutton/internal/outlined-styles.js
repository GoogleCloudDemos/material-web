...
export const styles = css`
  :host {
    ...
    --_icon-size: var(
      --md-outlined-segmented-button-icon-size,
      calc(18 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_spacing-leading: calc(12 * var(--md-sys-globalscale, 1px));
    --_spacing-trailing: calc(12 * var(--md-sys-globalscale, 1px));
  }
  .md3-segmented-button__outline {
    border-radius: inherit;
    border-style: solid;
    border-width: calc(1 * var(--md-sys-globalscale, 1px));
    inset: calc(0 * var(--md-sys-globalscale, 1px)) -calc(0.5 * var(--md-sys-globalscale, 1px));
    pointer-events: none;
    position: absolute;
  }
`
