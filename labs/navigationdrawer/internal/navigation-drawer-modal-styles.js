...
export const styles = css`
  :host {
    ...
    --_container-shape: var(
      --md-navigation-drawer-modal-container-shape,
      0 calc(16 * var(--md-sys-globalscale, 1px)) calc(16 * var(--md-sys-globalscale, 1px)) 0
    );
    --_container-width: var(
      --md-navigation-drawer-modal-container-width,
      calc(360 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_standard-container-elevation: var(
      --md-navigation-drawer-modal-standard-container-elevation,
      0
    );
  ...
  .md3-navigation-drawer-modal--opened {
    transition: inline-size 0.25s cubic-bezier(0.4, 0, 0.2, 1) 0s,
      visibility 0s cubic-bezier(0.4, 0, 0.2, 1) 0s;
  }
