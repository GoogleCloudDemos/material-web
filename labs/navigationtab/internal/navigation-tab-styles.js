...
export const styles = css`
  :host {
    ...
    --_active-indicator-height: var(
      --md-navigation-bar-active-indicator-height,
    ...
    --_active-indicator-width: var(
      --md-navigation-bar-active-indicator-width,
    ...
    --_container-color: var(
      --md-navigation-bar-container-color,
    ...
    --_container-height: var(
      --md-navigation-bar-container-height,
      calc(80 * var(--md-sys-globalscale, 1px))
    );
    --_container-shape: var(
      --md-navigation-bar-container-shape,
    ...
    --_icon-size: var(--md-navigation-bar-icon-size, calc(24 * var(--md-sys-globalscale, 1px)));
  ...
  md-focus-ring {
    ...
    --md-focus-ring-inward-offset: -calc(1 * var(--md-sys-globalscale, 1px));
  }
  .md3-navigation-tab {
    align-items: center;
    appearance: none;
    ...
    min-height: calc(48 * var(--md-sys-globalscale, 1px));
    min-width: calc(48 * var(--md-sys-globalscale, 1px));
    outline: none;
    padding: calc(8 * var(--md-sys-globalscale, 1px)) calc(0 * var(--md-sys-globalscale, 1px))
      calc(12 * var(--md-sys-globalscale, 1px));
    position: relative;
    text-align: center;
    width: 100%;
  ...
  .md3-navigation-tab__label-text {
    height: calc(16 * var(--md-sys-globalscale, 1px));
    margin-top: calc(4 * var(--md-sys-globalscale, 1px));
    opacity: 1;
  ...
  .md3-navigation-tab__active-indicator {
    ...
    width: calc(32 * var(--md-sys-globalscale, 1px));
