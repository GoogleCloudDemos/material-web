...
export const styles = css`
  :host {
    --_container-height: var(
      --md-assist-chip-container-height,
    ...
    --_icon-size: var(--md-assist-chip-icon-size, calc(18 * var(--md-sys-globalscale, 1px)));
    ...
    --_container-shape-start-start: var(
      ...
      var(
        --md-assist-chip-container-shape,
