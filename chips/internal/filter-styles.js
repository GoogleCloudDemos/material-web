...
export const styles = css`
  :host {
    --_container-height: var(
      --md-filter-chip-container-height,
    ...
    --_elevated-disabled-container-elevation: var(
      --md-filter-chip-elevated-disabled-container-elevation,
      0
    );
    --_elevated-disabled-container-opacity: var(
      --md-filter-chip-elevated-disabled-container-opacity,
      0.12
    );
    --_elevated-focus-container-elevation: var(
      --md-filter-chip-elevated-focus-container-elevation,
      1
    );
    --_elevated-hover-container-elevation: var(
      --md-filter-chip-elevated-hover-container-elevation,
      2
    );
    --_elevated-pressed-container-elevation: var(
      --md-filter-chip-elevated-pressed-container-elevation,
      1
    );
    ...
    --_label-text-size: var(
      --md-filter-chip-label-text-size,
      var(
    ...
    --_selected-hover-state-layer-opacity: var(
      --md-filter-chip-selected-hover-state-layer-opacity,
      0.08
    );
    ...
    --_selected-pressed-state-layer-opacity: var(
      --md-filter-chip-selected-pressed-state-layer-opacity,
      0.12
    );
    ...
    --_disabled-selected-container-opacity: var(
      --md-filter-chip-disabled-selected-container-opacity,
      0.12
    );
    ...
    --_label-text-color: var(
      --md-filter-chip-label-text-color,
      var(--md-sys-color-on-surface-variant, #49454f)
    );
    ...
    --_icon-size: var(--md-filter-chip-icon-size, calc(18 * var(--md-sys-globalscale, 1px)));
    ...
    --_leading-icon-color: var(
      --md-filter-chip-leading-icon-color,
      var(--md-sys-color-primary, #6750a4)
    );
    ...
    --_container-shape-start-start: var(
      ...
      var(
        --md-filter-chip-container-shape,
    ...
    --_leading-space: var(
      --md-filter-chip-leading-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    --_trailing-space: var(
      --md-filter-chip-trailing-space,
      calc(16 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_with-leading-icon-leading-space: var(
      --md-filter-chip-with-leading-icon-leading-space,
      calc(8 * var(--md-sys-globalscale, 1px))
    );
    --_with-trailing-icon-trailing-space: var(
      --md-filter-chip-with-trailing-icon-trailing-space,
      calc(8 * var(--md-sys-globalscale, 1px))
    );
  }
