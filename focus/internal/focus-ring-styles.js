...
export const styles = css`
  ...
  :host(:not([inward])) {
    ...
    border-end-end-radius: calc(
      var(
        ...
        ) + var(--md-focus-ring-outward-offset, calc(2 * var(--md-sys-globalscale, 1px)))
    );
    ...
    inset: calc(
      -1 * var(--md-focus-ring-outward-offset, calc(2 * var(--md-sys-globalscale, 1px)))
    );
    outline: var(--md-focus-ring-width, calc(3 * var(--md-sys-globalscale, 1px))) solid
      currentColor;
  }
  :host([inward]) {
    ...
    border-end-end-radius: calc(
      var(
        ...
        ) - var(--md-focus-ring-inward-offset, calc(0 * var(--md-sys-globalscale, 1px)))
    );
    border-end-start-radius: calc(
      var(
          --md-focus-ring-shape-end-start,
    ...
    border: var(--md-focus-ring-width, calc(3 * var(--md-sys-globalscale, 1px))) solid currentColor;
    inset: var(--md-focus-ring-inward-offset, calc(0 * var(--md-sys-globalscale, 1px)));
  }
  @keyframes outward-grow {
    ...
    to {
      outline-width: var(--md-focus-ring-active-width, calc(8 * var(--md-sys-globalscale, 1px)));
    }
  }
  ...
  @keyframes inward-grow {
    ...
    to {
      border-width: var(--md-focus-ring-active-width, calc(8 * var(--md-sys-globalscale, 1px)));
    }
  }
