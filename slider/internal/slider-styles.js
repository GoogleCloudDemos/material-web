...
export const styles = css`
  :host {
    ...
    --_active-track-height: var(
      --md-slider-active-track-height,
    ...
    --_handle-height: var(--md-slider-handle-height, calc(20 * var(--md-sys-globalscale, 1px)));
    --_handle-shadow-color: var(--md-slider-handle-shadow-color, var(--md-sys-color-shadow, #000));
    --_handle-shape: var(
      --md-slider-handle-shape,
      var(--md-sys-shape-corner-full, calc(9999 * var(--md-sys-globalscale, 1px)))
    );
    --_handle-width: var(--md-slider-handle-width, calc(20 * var(--md-sys-globalscale, 1px)));
    ...
    --_inactive-track-height: var(
      --md-slider-inactive-track-height,
      calc(4 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_label-container-height: var(
      --md-slider-label-container-height,
      calc(28 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_state-layer-size: var(
      --md-slider-state-layer-size,
    ...
    min-inline-size: calc(200 * var(--md-sys-globalscale, 1px));
  ...
  .tickmarks::after {
    ...
    background-size: calc((100% - var(--_with-tick-marks-container-size) * 2) / var(--_tick-count))
      100%;
  }
  .track::before,
  .tickmarks::before {
  ...
  :host([disabled]) .track::before {
    opacity: calc(
      1 / var(--_disabled-active-track-opacity) * var(--_disabled-inactive-track-opacity)
    );
  ...
  .handle.start {
    inset-inline-start: calc(
      calc(0 * var(--md-sys-globalscale, 1px)) - var(--_state-layer-size) / 2
    );
  }
  .handle.end {
  ...
  .label {
    ...
    display: flex;
    padding: calc(4 * var(--md-sys-globalscale, 1px));
    place-content: center;
    place-items: center;
    border-radius: var(--md-sys-shape-corner-full, calc(9999 * var(--md-sys-globalscale, 1px)));
  ...
  .label::after {
    inset: calc(0 * var(--md-sys-globalscale, 1px));
