...
export const styles = css`
  ...
  :host([size='medium'][touch-target='wrapper']) {
    margin: max(
      ...
      calc(48 * var(--md-sys-globalscale, 1px)) - var(--_container-height)
    );
  }
  :host([size='large'][touch-target='wrapper']) {
    margin: max(
      calc(0 * var(--md-sys-globalscale, 1px)),
      calc(48 * var(--md-sys-globalscale, 1px)) - var(--_large-container-height)
    );
  }
  .fab,
  .icon,
  ...
  .fab {
    ...
    border-width: calc(0 * var(--md-sys-globalscale, 1px));
    outline: none;
    z-index: 0;
  ...
  .fab.extended {
    ...
    padding-inline-start: calc(16 * var(--md-sys-globalscale, 1px));
    padding-inline-end: calc(20 * var(--md-sys-globalscale, 1px));
  }
  .fab:not(.extended) {
  ...
  .fab.extended .icon ::slotted(*) {
    margin-inline-end: calc(12 * var(--md-sys-globalscale, 1px));
  }
  .ripple {
    overflow: hidden;
  }
