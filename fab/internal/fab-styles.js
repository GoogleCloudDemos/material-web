...
export const styles = css`
  :host {
    ...
    --_container-height: var(--md-fab-container-height, calc(56 * var(--md-sys-globalscale, 1px)));
    --_container-shadow-color: var(
      --md-fab-container-shadow-color,
      var(--md-sys-color-shadow, #000)
    );
    --_container-width: var(--md-fab-container-width, calc(56 * var(--md-sys-globalscale, 1px)));
    ...
    --_hover-state-layer-color: var(
      --md-fab-hover-state-layer-color,
    ...
    --_icon-size: var(--md-fab-icon-size, calc(24 * var(--md-sys-globalscale, 1px)));
    ...
    --_large-container-height: var(
      --md-fab-large-container-height,
      calc(96 * var(--md-sys-globalscale, 1px))
    );
    --_large-container-width: var(
      --md-fab-large-container-width,
      calc(96 * var(--md-sys-globalscale, 1px))
    );
    --_large-icon-size: var(--md-fab-large-icon-size, calc(36 * var(--md-sys-globalscale, 1px)));
    --_pressed-label-text-color: var(
      --md-fab-pressed-label-text-color,
      var(--md-sys-color-primary, #6750a4)
    );
    ...
    --_small-container-height: var(
      --md-fab-small-container-height,
      calc(40 * var(--md-sys-globalscale, 1px))
    );
    --_small-container-width: var(
      --md-fab-small-container-width,
      calc(40 * var(--md-sys-globalscale, 1px))
    );
    --_small-icon-size: var(--md-fab-small-icon-size, calc(24 * var(--md-sys-globalscale, 1px)));
    ...
    --_container-shape-start-start: var(
      ...
      var(
        ...
        var(--md-sys-shape-corner-large, calc(16 * var(--md-sys-globalscale, 1px)))
      )
    );
    ...
    --_large-container-shape-start-start: var(
      ...
      var(
        ...
        var(--md-sys-shape-corner-extra-large, calc(28 * var(--md-sys-globalscale, 1px)))
      )
    );
  ...
  :host([size='small'][touch-target='wrapper']) {
    margin: max(
      ...
      calc(48 * var(--md-sys-globalscale, 1px)) - var(--_small-container-height)
    );
  }
  .fab {
    cursor: inherit;
