...
export const styles = css`
  :host {
    --_container-color: var(
      --md-fab-branded-container-color,
    ...
    --_container-height: var(
      --md-fab-branded-container-height,
      calc(56 * var(--md-sys-globalscale, 1px))
    );
    --_container-shadow-color: var(
      --md-fab-branded-container-shadow-color,
      var(--md-sys-color-shadow, #000)
    );
    --_container-width: var(
      --md-fab-branded-container-width,
      calc(56 * var(--md-sys-globalscale, 1px))
    );
    ...
    --_hover-state-layer-color: var(
      --md-fab-branded-hover-state-layer-color,
      var(--md-sys-color-primary, #6750a4)
    );
    --_hover-state-layer-opacity: var(--md-fab-branded-hover-state-layer-opacity, 0.08);
    --_icon-size: var(--md-fab-branded-icon-size, calc(36 * var(--md-sys-globalscale, 1px)));
    ...
    --_lowered-focus-container-elevation: var(
      --md-fab-branded-lowered-focus-container-elevation,
      1
    );
    --_lowered-hover-container-elevation: var(
      --md-fab-branded-lowered-hover-container-elevation,
      2
    );
    --_lowered-pressed-container-elevation: var(
      --md-fab-branded-lowered-pressed-container-elevation,
      1
    );
    ...
    --_focus-label-text-color: var(
      --md-fab-branded-focus-label-text-color,
      var(--md-sys-color-primary, #6750a4)
    );
    --_hover-label-text-color: var(
      --md-fab-branded-hover-label-text-color,
      var(--md-sys-color-primary, #6750a4)
    );
    --_label-text-color: var(
      --md-fab-branded-label-text-color,
    ...
    --_label-text-size: var(
      --md-fab-branded-label-text-size,
      var(
    ...
    --_large-container-height: var(
      --md-fab-branded-large-container-height,
      calc(96 * var(--md-sys-globalscale, 1px))
    );
    --_large-container-width: var(
      --md-fab-branded-large-container-width,
      calc(96 * var(--md-sys-globalscale, 1px))
    );
    --_large-icon-size: var(
      --md-fab-branded-large-icon-size,
    ...
    --_container-shape-start-start: var(
      ...
      var(
        --md-fab-branded-container-shape,
    ...
    --_large-container-shape-start-start: var(
      ...
      var(
        --md-fab-branded-large-container-shape,
