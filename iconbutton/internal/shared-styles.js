...
export const styles = css`
  ...
  :host([touch-target='wrapper']) {
    margin: max(
      ...
      max(
        calc(0 * var(--md-sys-globalscale, 1px)),
        (calc(48 * var(--md-sys-globalscale, 1px)) - var(--_container-width))/2
      );
  }
  md-focus-ring {
  ...
  .touch {
    position: absolute;
    height: max(calc(48 * var(--md-sys-globalscale, 1px)), 100%);
    width: max(calc(48 * var(--md-sys-globalscale, 1px)), 100%);
  }
