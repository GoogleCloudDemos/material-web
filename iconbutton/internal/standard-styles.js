...
export const styles = css`
  :host {
    ...
    --_icon-size: var(--md-icon-button-icon-size, calc(24 * var(--md-sys-globalscale, 1px)));
  ...
  :host([touch-target='wrapper']) {
    margin: max(
        ...
        (calc(48 * var(--md-sys-globalscale, 1px)) - var(--_state-layer-height))/2
      )
      max(
        calc(0 * var(--md-sys-globalscale, 1px)),
        (calc(48 * var(--md-sys-globalscale, 1px)) - var(--_state-layer-width))/2
      );
  }
  md-focus-ring {
