...
export const styles = css`
  :host {
    --_container-height: var(
      --md-text-button-container-height,
    ...
    --_icon-size: var(--md-text-button-icon-size, calc(18 * var(--md-sys-globalscale, 1px)));
    ...
    --_leading-space: var(
      --md-text-button-leading-space,
      calc(12 * var(--md-sys-globalscale, 1px))
    );
    --_trailing-space: var(
      --md-text-button-trailing-space,
      calc(12 * var(--md-sys-globalscale, 1px))
    );
